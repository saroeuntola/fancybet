...
class Post {
    ...
    public function getPostByCategory($categoryId, $lang = 'en', $limit = null, $offset = null, $orderBy = 'created_at', $orderDir = 'DESC')
    {
        ...
        $validColumns = ['created_at', 'name'];
        $orderBy = in_array($orderBy, $validColumns) ? $orderBy : 'created_at';
    ...
    public function getPostBySitemap($lang = 'en')
    {
        // Validate language
        $lang = in_array($lang, ['en', 'bn']) ? $lang : 'en';
